...
public class ShDetail {
	...
	public static void main(String[] args) {
	    ...
	    SoftwareHouse SF1 = new SoftwareHouse("SOFTWARE HOUSE 1\n", Employee.createMember("Alison", d, empd1,empd2), Employee.createMember("Umer", d, empd1,empd2), Employee.createMember("Mutahir", d, empd1,empd2));
	    SoftwareHouse SF2 = new SoftwareHouse("SOFTWARE HOUSE 2\n", Employee.createMember("Talha", d, empd1,empd2), Employee.createMember("Mutahir", d, empd1,empd2), Employee.createMember("Alison", d, empd1,empd2));
